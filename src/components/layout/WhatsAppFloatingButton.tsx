...
export function WhatsAppFloatingButton() {
  ...
  return (
    <motion.a
      ...
      whileTap={{ scale: 0.95 }}
      className="fixed bottom-24 md:bottom-6 right-4 md:right-6 z-40 h-14 w-14 rounded-full bg-[#25D366] text-white shadow-glow flex items-center justify-center"
    >
